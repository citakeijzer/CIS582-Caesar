...
def process_order(order):
    ...
    while 1:
        ...
        if firstmatch.sell_amount > neworder.buy_amount:
            ...
            suborder['buy_amount'] = ((firstmatch.sell_amount - neworder.buy_amount) / firstmatch.sell_amount) * firstmatch.buy_amount
            ...
            suborder['sell_amount'] = ((neworder.buy_amount - firstmatch.sell_amount) / neworder.buy_amount) * neworder.sell_amount
